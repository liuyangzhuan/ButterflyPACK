...
module d_BPACK_hmat_ptg_bridge
   use iso_c_binding
   use d_BPACK_DEFS
   use d_BPACK_factor
   use d_BPACK_block_sendrecv
   use d_BPACK_Utilities
   use d_MISC_Utilities
   use d_Bplus_Utilities
contains

   subroutine d_c_bpack_hmat_ptg_rank(ptree_Cptr, rank) bind(c, name="d_c_bpack_hmat_ptg_rank")
      implicit none
      ...
      rank = ptree%MyID
   end subroutine d_c_bpack_hmat_ptg_rank

   subroutine d_c_bpack_hmat_ptg_size(ptree_Cptr, size) bind(c, name="d_c_bpack_hmat_ptg_size")
      implicit none
      type(c_ptr), intent(in) :: ptree_Cptr
      ...
      call c_f_pointer(ptree_Cptr, ptree)
      size = ptree%nproc
   end subroutine d_c_bpack_hmat_ptg_size

   subroutine d_c_bpack_hmat_ptg_owner_of(hmat_Cptr, ptree_Cptr, row0, col0, owner) bind(c, name="d_c_bpack_hmat_ptg_owner_of")
      implicit none
   ...
   end subroutine d_c_bpack_hmat_ptg_owner_of

   subroutine d_c_bpack_hmat_ptg_diag(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, out_ptr, out_bytes) bind(c, name="d_c_bpack_hmat_ptg_diag")
      implicit none
   ...
   end subroutine d_c_bpack_hmat_ptg_diag

   subroutine d_c_bpack_hmat_ptg_upanel(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, j0, diag_ptr, out_ptr, out_bytes) bind(c, name="d_c_bpack_hmat_ptg_upanel")
      implicit none
      type(c_ptr), intent(in) :: hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr
      ...
      out_ptr = c_loc(buffer(1))
      out_bytes = int(count_dt, c_int64_t)*int(storage_size(buffer(1))/8, c_int64_t)
   end subroutine d_c_bpack_hmat_ptg_upanel

   subroutine d_c_bpack_hmat_ptg_lpanel(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, i0, diag_ptr, out_ptr, out_bytes) bind(c, name="d_c_bpack_hmat_ptg_lpanel")
      implicit none
      type(c_ptr), intent(in) :: hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr
      ...
      out_ptr = c_loc(buffer(1))
      out_bytes = int(count_dt, c_int64_t)*int(storage_size(buffer(1))/8, c_int64_t)
   end subroutine d_c_bpack_hmat_ptg_lpanel

   subroutine d_c_bpack_hmat_ptg_update(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, i0, j0, l_ptr, u_ptr) bind(c, name="d_c_bpack_hmat_ptg_update")
      implicit none
      type(c_ptr), intent(in) :: hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr
      ...
      deallocate(l_block)
      deallocate(u_block)
   end subroutine d_c_bpack_hmat_ptg_update

   subroutine d_c_bpack_hmat_ptg_release_buffer(ptr) bind(c, name="d_c_bpack_hmat_ptg_release_buffer")
      implicit none
   ...
   end subroutine d_c_bpack_hmat_ptg_release_buffer
...
end module d_BPACK_hmat_ptg_bridge
