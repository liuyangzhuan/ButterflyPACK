...
*
*> Download SGETRFmod + dependencies
...
*  ===========
*
*       SUBROUTINE SGETRFmod( M, N, A, LDA, IPIV, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> SGETRFmod computes an LU factorization of a general M-by-N matrix A
...
*  =====================================================================
      ...
      SUBROUTINE sgetrfmod( M, N, A, LDA, THRESH, IPIV, INFO )
*
...
*     .. External Subroutines ..
      EXTERNAL           sgemm, sgetrf2mod, slaswp, strsm,
     $                   xerbla
*     ..
*     .. External Functions ..
      INTEGER            ILAENV
...
*
      nb = ilaenv( 1, 'SGETRFmod', ' ', m, n, -1, -1 )
      IF( nb.LE.1 .OR. nb.GE.min( m, n ) ) THEN
*
*        Use unblocked code.
*
         CALL sgetrf2mod( m, n, a, lda, THRESH, ipiv, info )
      ELSE
*
*        Use blocked code.
*
...
*           singularity.
*
            CALL sgetrf2mod( m-j+1, jb, a( j, j ), lda, THRESH, ipiv( j ),
     $                    iinfo )
*
