...
subroutine C_HODLR_Createptree(nmpi,groupmembers,MPIcomm,ptree_Cptr) bind(c, name="d_c_hodlr_createptree")	
	implicit none 
	integer nmpi
	integer MPIcomm
...
subroutine C_HODLR_Createstats(stats_Cptr) bind(c, name="d_c_hodlr_createstats")	
	implicit none 
...
!**** C interface of printing statistics
	!stats_Cptr: the structure containing statistics
	!ptree_Cptr: the structure containing process tree
subroutine C_HODLR_Printstats(stats_Cptr,ptree_Cptr) bind(c, name="d_c_hodlr_printstats")	
	implicit none 
...
subroutine C_HODLR_Createoption(option_Cptr) bind(c, name="d_c_hodlr_createoption")	
	implicit none 
...
!**** C interface of set one entry in option
	!option_Cptr: the structure containing option       
subroutine C_HODLR_Setoption(option_Cptr,nam,val_Cptr) bind(c, name="d_c_hodlr_setoption")	
	implicit none 
	type(c_ptr) :: option_Cptr
...
subroutine C_HODLR_Construct(Npo,Ndim,Locations,nlevel,tree,Permutation,Npo_loc,ho_bf_Cptr,option_Cptr,stats_Cptr,msh_Cptr,ker_Cptr,ptree_Cptr,C_FuncZmn,C_QuantZmn,MPIcomm) bind(c, name="d_c_hodlr_construct")	
	implicit none 
	integer Npo,Ndim
    ...
    call d_HODLR_construction(ho_bf,option,stats,msh,ker,element_Zmn_user_C,ptree)
...
!**** C interface of HODLR factorization
	...
	!stats_Cptr: the structure containing statistics         
	!ptree_Cptr: the structure containing process tree
subroutine C_HODLR_Factor(ho_bf_for_Cptr,option_Cptr,stats_Cptr,ptree_Cptr) bind(c, name="d_c_hodlr_factor")	
	implicit none 
...
!**** C interface of HODLR solve
	...
	!stats_Cptr: the structure containing statistics         
	!ptree_Cptr: the structure containing process tree
subroutine C_HODLR_Solve(x,b,Nloc,Nrhs,ho_bf_for_Cptr,option_Cptr,stats_Cptr,ptree_Cptr) bind(c, name="d_c_hodlr_solve")	
	implicit none 
...
!**** C interface of HODLR-vector multiplication
	...
	!stats_Cptr: the structure containing statistics         
	!ptree_Cptr: the structure containing process tree
subroutine C_HODLR_Mult(trans,xin,xout,Nloc,Ncol,ho_bf_for_Cptr,option_Cptr,stats_Cptr,ptree_Cptr) bind(c, name="d_c_hodlr_mult")	
	implicit none 
	real(kind=8) t1,t2
	integer Nloc,Ncol
