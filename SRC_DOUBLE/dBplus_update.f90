...
! If LR, call LR_Sblock; if butterfly, call BF_randomized; if Bplus, call d_Bplus_randomized_constr  
...
subroutine Bplus_Sblock_randomized_memfree(ho_bf1,level_c,rowblock,option,stats,ptree)
	...
	if(bplus%Lplus==1)then
		...
		level_butterfly = block_o%level_butterfly
		call d_Bplus_randomized_constr(level_butterfly,Bplus,ho_bf1,rank0_inner,rankrate_inner,Bplus_block_MVP_Sblock_dat,rank0_outter,rankrate_outter,Bplus_block_MVP_Outter_Sblock_dat,error_inout,'Sblock+',option,stats,ptree)
