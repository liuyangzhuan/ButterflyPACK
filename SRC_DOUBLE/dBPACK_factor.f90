...
contains
    ...
    subroutine Hmat_Factorization(h_mat, option, stats, ptree, msh)
        ...
        interface
            subroutine d_c_bpack_hmat_factorization_ptg(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, nb, ierr) bind(c, name="d_c_bpack_hmat_factorization_ptg")
            ...
            end subroutine d_c_bpack_hmat_factorization_ptg
        end interface
#endif
      ...
      !$omp single
        ...
        if(option%ILU==1)then
            ...
            if(option%use_parsec==1)then
                ...
                call d_c_bpack_hmat_factorization_ptg(c_loc(h_mat), c_loc(option), c_loc(stats), c_loc(ptree), c_loc(msh), int(num_blocks, c_int), ptg_ierr)
