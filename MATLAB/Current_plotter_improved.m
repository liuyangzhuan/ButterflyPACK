...
% freqstr='_freq_2180000000.0000000';
% freqstr='_freq_2200000000.0000000';
...
% freqstr='_freq_1930200000.0000000';
% freqstr='_freq_1950500000.0000000';
% freqstr='_freq_2227900000.0000000';
% freqstr='_freq_2192100000.0000000';
% freqstr='_freq_2225600000.0000000';
% freqstr='_freq_1941000000.0000000';
% freqstr='_freq_2160100000.0000000';
freqstr='_freq_2197200000.0000000';
% 
...
ith=0;
for i=1:nev
fid1 = fopen (['code_outputs/',name,'_EigVecJ_',num2str(i),freqstr,'.out'],'r');
if(fid1~=-1)
    ...
    if(norm(CV,1)>threshold)
        ...
        print ('-djpeg','-r300',fname)
            ...
            fid1 = fopen (['code_outputs/',name,'_EigVecM_',num2str(i),freqstr,'.out'],'r');
            X=xyz2(:,1);
            Y=xyz2(:,2);
            Z=xyz2(:,3);
         ...
         if(noEn==0) 
            ...
            fid1 = fopen (['code_outputs/',name,'_EigEn_',num2str(i),freqstr,'.out'],'r');
            X=xyz2(:,1);
            Y=xyz2(:,2);
            Z=xyz2(:,3);
            ...
            fid1 = fopen (['code_outputs/',name,'_EigEn1_',num2str(i),freqstr,'.out'],'r');
            X=xyz2(:,1);
            Y=xyz2(:,2);
            Z=xyz2(:,3);
         ...
         if(noEobs==0) 
            ...
            E_GF = load (['code_outputs/',name,'_Eobs_',num2str(i),freqstr,'.out'],'r');
