...
sed -i -e "s/c_bp_/z_c_bp_/g" $ZSRCDIR/*.h
sed -i -e "s/c_bf_/z_c_bf_/g" $ZSRCDIR/*.cpp
sed -i -e "s/c_bp_/z_c_bp_/g" $ZSRCDIR/*.cpp
...
sed -i -e "s/c_bp_/z_c_bp_/g" $ZSRCDIR/*.f90
...
sed -i -e "s/c_bp_/d_c_bp_/g" $DSRCDIR/*.h
sed -i -e "s/c_bf_/d_c_bf_/g" $DSRCDIR/*.cpp
sed -i -e "s/c_bp_/d_c_bp_/g" $DSRCDIR/*.cpp
...
sed -i -e "s/c_bp_/d_c_bp_/g" $DSRCDIR/*.f90
...
sed -i -e "s/c_bp_/c_c_bp_/g" $CSRCDIR/*.h
sed -i -e "s/c_bf_/c_c_bf_/g" $CSRCDIR/*.cpp
sed -i -e "s/c_bp_/c_c_bp_/g" $CSRCDIR/*.cpp
...
sed -i -e "s/c_bp_/c_c_bp_/g" $CSRCDIR/*.f90
...
sed -i -e "s/c_bp_/s_c_bp_/g" $SSRCDIR/*.h
sed -i -e "s/c_bf_/s_c_bf_/g" $SSRCDIR/*.cpp
sed -i -e "s/c_bp_/s_c_bp_/g" $SSRCDIR/*.cpp
...
sed -i -e "s/c_bp_/s_c_bp_/g" $SSRCDIR/*.f90
