...
/*! @file
 * @brief This c++ example compresses a matrix representing discretized Green's function ansatz for Helmholtz equations in 3D inhomogenous media, using entry-evaluation-based APIs. The entry evaluation function is generated from running matlab coder. The example works on the double-complex data type.
*/
