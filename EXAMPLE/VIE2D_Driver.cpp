...
if(myrank==master_rank){
  ...
  if(vs==1){
    ...
    std::copy(perms_bf, perms_bf + Npo, quant_ptr_bf_s2s->_Hperm.begin());
	  ...
	  z_c_bpack_printoption(&option_bf,&ptree_bf);
  	z_c_bpack_construct_element_compute(&bmat_bf_s2s, &option_bf, &stats_bf_s2s, &msh_bf_s2s, &kerquant_bf_s2s, &ptree_bf, &C_FuncZmn_BF, &C_FuncZmnBlock_BF_S2S, quant_ptr_bf_s2s);
