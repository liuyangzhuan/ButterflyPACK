...
*/
/*! @file
 * @brief This c++ example compresses a 1D Fourier integral operators (FIO) as a butterfly using entry-evaluation-based APIs, then constructs a preconditioner for the inverse FIO using matvec-based APIs. The example works on the double-complex data type.
*/
//------------------------------------------------------------------------------
#include <iostream>
#include <math.h>
...
if(myrank==master_rank){
  ...
  quant_ptr_a=new C_QuantApp(M, N, ker);
