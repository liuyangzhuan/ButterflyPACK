...
extern "C" {
    ...
    void c_hodlr_construct_matvec(int* Npo, int* nlevel, int* tree, int* perms, int* Npo_loc, F2Cptr* ho_bf_for, F2Cptr* option,F2Cptr* stats,F2Cptr* msh,F2Cptr* ker,F2Cptr* ptree, void (*C_FuncMatVec)(char const *, int*, int*, int*, C_DT*,C_DT*,C2Fptr), C2Fptr C_QuantApp, MPI_Fint* MPIcomm);
	...
	void c_hodlr_mult(char const * trans, C_DT* xin, C_DT* xout, int* Ninloc, int* Noutloc, int* Ncol, F2Cptr* ho_bf_for,F2Cptr* option,F2Cptr* stats,F2Cptr* ptree);	
