...
contains
   ...
   subroutine c_bpack_hmat_ptg_rank(ptree_Cptr, rank) bind(c, name="c_bpack_hmat_ptg_rank")
      implicit none
      ...
      rank = ptree%MyID
   end subroutine c_bpack_hmat_ptg_rank

   subroutine c_bpack_hmat_ptg_size(ptree_Cptr, size) bind(c, name="c_bpack_hmat_ptg_size")
      implicit none
      type(c_ptr), intent(in) :: ptree_Cptr
      ...
      call c_f_pointer(ptree_Cptr, ptree)
      size = ptree%nproc
   end subroutine c_bpack_hmat_ptg_size

   subroutine c_bpack_hmat_ptg_owner_of(hmat_Cptr, ptree_Cptr, row0, col0, owner) bind(c, name="c_bpack_hmat_ptg_owner_of")
      implicit none
   ...
   subroutine c_bpack_hmat_ptg_diag(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, out_ptr, out_bytes) bind(c, name="c_bpack_hmat_ptg_diag")
      implicit none
   ...
   end subroutine c_bpack_hmat_ptg_diag

   subroutine c_bpack_hmat_ptg_upanel(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, j0, diag_ptr, out_ptr, out_bytes) bind(c, name="c_bpack_hmat_ptg_upanel")
      implicit none
      type(c_ptr), intent(in) :: hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr
      ...
      out_ptr = c_loc(buffer(1))
      out_bytes = int(count_dt, c_int64_t)*int(storage_size(buffer(1))/8, c_int64_t)
   end subroutine c_bpack_hmat_ptg_upanel

   subroutine c_bpack_hmat_ptg_lpanel(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, i0, diag_ptr, out_ptr, out_bytes) bind(c, name="c_bpack_hmat_ptg_lpanel")
      implicit none
      type(c_ptr), intent(in) :: hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr
      ...
      out_ptr = c_loc(buffer(1))
      out_bytes = int(count_dt, c_int64_t)*int(storage_size(buffer(1))/8, c_int64_t)
   end subroutine c_bpack_hmat_ptg_lpanel

   subroutine c_bpack_hmat_ptg_update(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, i0, j0, l_ptr, u_ptr) bind(c, name="c_bpack_hmat_ptg_update")
      implicit none
      type(c_ptr), intent(in) :: hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr
      ...
      deallocate(l_block)
      deallocate(u_block)
   end subroutine c_bpack_hmat_ptg_update

   subroutine c_bpack_hmat_ptg_release_buffer(ptr) bind(c, name="c_bpack_hmat_ptg_release_buffer")
      implicit none
   ...
   end subroutine c_bpack_hmat_ptg_release_buffer
...
end module BPACK_hmat_ptg_bridge
