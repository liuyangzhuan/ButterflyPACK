...
#if HAVE_ZFP
      if(option%use_zfp==1)call ZFP_Decompress(blocks,tol_used,0)
#endif
         ! do ii=1,size_m
         ! do jj=1,size_m
         ...
         ! enddo
#if HAVE_ZFP
         if(option%use_zfp==1)call ZFP_Compress(blocks,option%tol_comp,0)
#endif
      else
         do ii = 1, size_m
            blocks%ipiv(ii) = ii
...
#if HAVE_ZFP
      if(option%use_zfp==1)call ZFP_Decompress(block3,tol_used,0)
#endif
...
#if HAVE_ZFP
      if(option%use_zfp==1)call ZFP_Compress(block3,option%tol_comp,0)
#endif
...
#if HAVE_ZFP
                  if(option%use_zfp==1)call ZFP_Decompress(block_o,tol_used,0)
#endif
#if 0
...
#endif
#if HAVE_ZFP
                  if(option%use_zfp==1)call ZFP_Compress(block_o,option%tol_comp,0)
#endif
               else
                  !!!!! invert I+B1 to be I+B2
                  level_butterfly = block_o%level_butterfly
