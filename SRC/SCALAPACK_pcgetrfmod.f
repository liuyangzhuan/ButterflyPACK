      SUBROUTINE pcgetrfmod( M, N, A, IA, JA, DESCA, THRESH, IPIV, INFO )
*
...
*  =======
*
*  pcgetrfmod computes an LU factorization of a general M-by-N distributed
...
*     .. External Subroutines ..
     ...
     $                   pb_topget, pb_topset, pcgemm, pcgetf2mod,
...
*
      IF( info.NE.0 ) THEN
         CALL pxerbla( ictxt, 'pcgetrfmod', -info )
         RETURN
      END IF
*
...
*     singularity.
*
      CALL pcgetf2mod( m, jb, a, ia, ja, desca, THRESH, ipiv, info )
*
      IF( jb+1.LE.n ) THEN
*
...
*        singularity.
*
         CALL pcgetf2mod( m-j+ja, jb, a, i, j, desca, THRESH, ipiv, iinfo )
*
