      SUBROUTINE psgetf2mod( M, N, A, IA, JA, DESCA, THRESH, IPIV, INFO )
*
...
*  =======
*
*  psgetf2mod computes an LU factorization of a general M-by-N
...
*     .. External Subroutines ..
     ...
     $                   igebs2d, infog2l, psamax, psger,
     $                   psscal, psswap, pb_topget, pxerbla, pselset
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          min, mod
*     ..
...
*
      IF( info.NE.0 ) THEN
         CALL pxerbla( ictxt, 'psgetf2mod', -info )
