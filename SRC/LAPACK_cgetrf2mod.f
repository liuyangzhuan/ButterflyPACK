...
*  ===========
*
*       RECURSIVE SUBROUTINE CGETRF2mod( M, N, A, LDA, IPIV, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> CGETRF2mod computes an LU factorization of a general M-by-N matrix A
...
*  =====================================================================
      ...
      RECURSIVE SUBROUTINE cgetrf2mod( M, N, A, LDA, THRESH, IPIV, INFO )
*
...
*               [ A21 ]
*
         CALL cgetrf2mod( m, n1, a, lda, THRESH, ipiv, iinfo )
...
*        Factor A22
*
         CALL cgetrf2mod( m-n1, n2, a( n1+1, n1+1 ), lda, THRESH, ipiv( n1+1 ),
     $                 iinfo )
*
