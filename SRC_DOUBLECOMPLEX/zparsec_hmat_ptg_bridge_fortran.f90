...
module z_BPACK_hmat_ptg_bridge
   use iso_c_binding
   use z_BPACK_DEFS
   use z_BPACK_factor
   use z_BPACK_block_sendrecv
   use z_BPACK_Utilities
   use z_MISC_Utilities
   use z_Bplus_Utilities
contains

   subroutine z_c_bpack_hmat_ptg_rank(ptree_Cptr, rank) bind(c, name="z_c_bpack_hmat_ptg_rank")
      implicit none
      ...
      rank = ptree%MyID
   end subroutine z_c_bpack_hmat_ptg_rank

   subroutine z_c_bpack_hmat_ptg_size(ptree_Cptr, size) bind(c, name="z_c_bpack_hmat_ptg_size")
      implicit none
      type(c_ptr), intent(in) :: ptree_Cptr
      ...
      call c_f_pointer(ptree_Cptr, ptree)
      size = ptree%nproc
   end subroutine z_c_bpack_hmat_ptg_size

   subroutine z_c_bpack_hmat_ptg_owner_of(hmat_Cptr, ptree_Cptr, row0, col0, owner) bind(c, name="z_c_bpack_hmat_ptg_owner_of")
      implicit none
   ...
   end subroutine z_c_bpack_hmat_ptg_owner_of

   subroutine z_c_bpack_hmat_ptg_diag(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, out_ptr, out_bytes) bind(c, name="z_c_bpack_hmat_ptg_diag")
      implicit none
   ...
   end subroutine z_c_bpack_hmat_ptg_diag

   subroutine z_c_bpack_hmat_ptg_upanel(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, j0, diag_ptr, out_ptr, out_bytes) bind(c, name="z_c_bpack_hmat_ptg_upanel")
      implicit none
      type(c_ptr), intent(in) :: hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr
      ...
      out_ptr = c_loc(buffer(1))
      out_bytes = int(count_dt, c_int64_t)*int(storage_size(buffer(1))/8, c_int64_t)
   end subroutine z_c_bpack_hmat_ptg_upanel

   subroutine z_c_bpack_hmat_ptg_lpanel(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, i0, diag_ptr, out_ptr, out_bytes) bind(c, name="z_c_bpack_hmat_ptg_lpanel")
      implicit none
      type(c_ptr), intent(in) :: hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr
      ...
      out_ptr = c_loc(buffer(1))
      out_bytes = int(count_dt, c_int64_t)*int(storage_size(buffer(1))/8, c_int64_t)
   end subroutine z_c_bpack_hmat_ptg_lpanel

   subroutine z_c_bpack_hmat_ptg_update(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, i0, j0, l_ptr, u_ptr) bind(c, name="z_c_bpack_hmat_ptg_update")
      implicit none
      type(c_ptr), intent(in) :: hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr
      ...
      deallocate(l_block)
      deallocate(u_block)
   end subroutine z_c_bpack_hmat_ptg_update

   subroutine z_c_bpack_hmat_ptg_release_buffer(ptr) bind(c, name="z_c_bpack_hmat_ptg_release_buffer")
      implicit none
   ...
   end subroutine z_c_bpack_hmat_ptg_release_buffer
...
end module z_BPACK_hmat_ptg_bridge
