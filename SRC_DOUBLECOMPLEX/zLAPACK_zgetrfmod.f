...
*
*> Download ZGETRFmod + dependencies
...
*  ===========
*
*       SUBROUTINE ZGETRFmod( M, N, A, LDA, IPIV, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> ZGETRFmod computes an LU factorization of a general M-by-N matrix A
...
*  =====================================================================
      ...
      SUBROUTINE zgetrfmod( M, N, A, LDA, THRESH, IPIV, INFO )
*
...
*     .. External Subroutines ..
      EXTERNAL           xerbla, zgemm, zgetrf2mod, zlaswp,
     $                   ztrsm
*     ..
*     .. External Functions ..
      INTEGER            ILAENV
...
*
      nb = ilaenv( 1, 'ZGETRFmod', ' ', m, n, -1, -1 )
      IF( nb.LE.1 .OR. nb.GE.min( m, n ) ) THEN
*
*        Use unblocked code.
*
         CALL zgetrf2mod( m, n, a, lda, THRESH, ipiv, info )
      ELSE
*
*        Use blocked code.
*
...
*           singularity.
*
            CALL zgetrf2mod( m-j+1, jb, a( j, j ), lda, THRESH, ipiv( j ),
     $                    iinfo )
*
