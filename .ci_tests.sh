...
19) python3 $DATA_FOLDER/Test_python_allranks.py -option --xyzsort 1 --tol_comp 1e-10 --lrlevel 0 --reclr_leaf 5 --nmin_leaf 128 --errsol 1 # all-rank python launch mode without MPI  
