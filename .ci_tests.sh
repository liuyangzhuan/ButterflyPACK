...
5) mpirun --allow-run-as-root  "-n" "8" "$EXAMPLE_FOLDER/ie3d" "-quant" "--data_dir" "$DATA_FOLDER/EM3D_DATA/sphere_2300" "--wavelength" "2.0" "-option" "--lr_blk_num" "1" "--tol_comp" "1e-2" "--errfillfull" "0" "--reclr_leaf" "4" "--baca_batch" "1" "--lrlevel" "0" "--precon" "1" "--xyzsort" "2" "--nmin_leaf" "100" "--near_para" "0.01d0" "--pat_comp" "3" "--format" "1"
   mpirun --allow-run-as-root  "-n" "8" "$EXAMPLE_FOLDER/ie3d" "-quant" "--data_dir" "$DATA_FOLDER/EM3D_DATA/sphere_2300" "--wavelength" "2.0" "-option" "--lr_blk_num" "1" "--tol_comp" "1e-2" "--errfillfull" "0" "--reclr_leaf" "4" "--baca_batch" "1" "--lrlevel" "100" "--precon" "1" "--xyzsort" "2" "--nmin_leaf" "100" "--near_para" "0.01d0" "--pat_comp" "3" "--format" "1"
   mpirun --allow-run-as-root  "-n" "8" "$EXAMPLE_FOLDER/ie3d_sp" "-quant" "--data_dir" "$DATA_FOLDER/EM3D_DATA/sphere_2300" "--wavelength" "2.0" "-option" "--lr_blk_num" "1" "--tol_comp" "1e-2" "--errfillfull" "0" "--reclr_leaf" "4" "--baca_batch" "1" "--lrlevel" "0" "--precon" "1" "--xyzsort" "2" "--nmin_leaf" "100" "--near_para" "0.01d0" "--pat_comp" "3" "--format" "1"
   mpirun --allow-run-as-root  "-n" "8" "$EXAMPLE_FOLDER/ie3d_sp" "-quant" "--data_dir" "$DATA_FOLDER/EM3D_DATA/sphere_2300" "--wavelength" "2.0" "-option" "--lr_blk_num" "1" "--tol_comp" "1e-2" "--errfillfull" "0" "--reclr_leaf" "4" "--baca_batch" "1" "--lrlevel" "100" "--precon" "1" "--xyzsort" "2" "--nmin_leaf" "100" "--near_para" "0.01d0" "--pat_comp" "3" "--format" "1";; # test HODLR with BF and LR for 3d IE (double and single precision)  
...
7) mpirun --allow-run-as-root  "-n" "2" "$EXAMPLE_FOLDER/ctest" "--tst" "1" "--N" "10000" "--trainfile" "$DATA_FOLDER/KRR_DATA/susy_10Kn" "--Ndim" "8" "--ker" "1" "--h" "0.1" "--lambda" "10.0" "--Nmin_leaf" "200" "--tol_comp" "1e-2" "--reclr_leaf" "5" "--errfillfull" "0" "--baca_batch" "16" "--knn" "10";; # test CPP interface with HODLR-LR for KRR with SUSY dataset
8) mpirun --allow-run-as-root  "-n" "7" "$EXAMPLE_FOLDER/ctest" "--tst" "2" "--N" "1000" "--Ndim" "8" "--ker" "1" "--h" "0.1" "--lambda" "10.0" "--Nmin_leaf" "100" "--tol_comp" "1e-4" "--reclr_leaf" "5" "--errfillfull" "0" "--baca_batch" "16" "--knn" "10";; # test CPP interface with HODLR-LR for KRR with random points
9) mpirun --allow-run-as-root  "-n" "3" "$EXAMPLE_FOLDER/ctest" "--tst" "3" "--N" "5000" "--rank_rand" "20" "--Nmin_leaf" "100" "--tol_comp" "1e-4" "--reclr_leaf" "5" "--errfillfull" "0";;  # test CPP interface with HODLR-LR for product of two random matrices 
10) mpirun --allow-run-as-root  "-n" "5" "$EXAMPLE_FOLDER/full" "-option" "--less_adapt" "0" "--errsol" "1";; # test HODLR with LR for reading a KRR matrix from a file 
11) mpirun --allow-run-as-root  "-n" "2" "$EXAMPLE_FOLDER/frontal" "-quant" "--data_dir" "$DATA_FOLDER/FULLMAT_DATA/Frontal_poisson_50.mat" "--nunk" "50" "--explicitflag" "0" "-option" "--lrlevel" "0" "--tol_comp" "1d-1" "--nmin_leaf" "100" "--errsol" "1" # test sampling-based construction of HODLR with LR for an 3D poisson frontal matrix stored in file
   mpirun --allow-run-as-root  "-n" "2" "$EXAMPLE_FOLDER/frontal" "-quant" "--data_dir" "$DATA_FOLDER/FULLMAT_DATA/Frontal_poisson_50.mat" "--nunk" "50" "--explicitflag" "0" "-option" "--lrlevel" "100" "--tol_comp" "1d-1" "--nmin_leaf" "100" "--errsol" "1" # test sampling-based construction of HODLR with BF for an 3D poisson frontal matrix stored in file
   mpirun --allow-run-as-root  "-n" "2" "$EXAMPLE_FOLDER/frontal" "-quant" "--data_dir" "$DATA_FOLDER/FULLMAT_DATA/Frontal_poisson_50.mat" "--nunk" "50" "--explicitflag" "1" "-option" "--lrlevel" "100" "--tol_comp" "1d-1" "--nmin_leaf" "100" "--errsol" "1";; # test entry-evaluation-based construction of HODLR with BF for an 3D poisson frontal matrix stored in file   
...
#    cd $ROOT_DIR/build
#     mpirun --allow-run-as-root  "-n" "8" "$EXAMPLE_FOLDER/fullkrr" "-quant" "-lambda" "0.03" "-option" "--reclr_leaf" "5" "--tol_comp" "1e-7" "--xyzsort" "3";; # test full matrix kernel regression with entry-based construction of HODLR with LR for a kernel matrix stored in file, with angular gram distance-based reordering and H-BACA
15) mpirun --allow-run-as-root  "-n" "8" "$EXAMPLE_FOLDER/go2d" "-quant" "--nunk" "5000" "--omega" "31.4" "-option" "--tol_comp" "1e-6" "--lrlevel" "100" "--xyzsort" "2" "--nmin_leaf" "100" "--format" "1" # test the taylor-expansion-based 2D approximate Green function 
    mpirun --allow-run-as-root  "-n" "8" "$EXAMPLE_FOLDER/go3d" "-quant" "--nunk" "5000" "--omega" "31.4" "-option" "--tol_comp" "1e-6" "--lrlevel" "100" "--xyzsort" "2" "--nmin_leaf" "100" "--format" "1";; # test the taylor-expansion-based 3D approximate Green function 
16) mpirun --allow-run-as-root  "-n" "7" "$EXAMPLE_FOLDER/cfio" "--tst" "2" "--M" "1500" "--N" "1000" "--K" "2000" "--L" "1800" "--lrlevel" "100" # test CPP interface for compressing product of three FIOs 
    mpirun --allow-run-as-root  "-n" "7" "$EXAMPLE_FOLDER/cifio" "--M" "1000" "--N" "1000" "--ker" "1" "--errsol 1" "--format" "1" # test CPP interface for approximate inverse of a 1D FIO, using HODLR    
    mpirun --allow-run-as-root  "-n" "8" "$EXAMPLE_FOLDER/cifio" "--M" "1000" "--N" "1000" "--ker" "1" "--errsol 1" "--format" "2" "--near_para" "4.0";; # test CPP interface for approximate inverse of a 1D FIO, using strong admissible H matrix     
