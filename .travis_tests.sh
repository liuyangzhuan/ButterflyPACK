...
2) mpirun "-n" "2" "$EXAMPLE_FOLDER/ie2d" "1" "10" "5000" "0.08" "1d-4" "0" "4" "16" "0";;
3) mpirun "-n" "1" "$EXAMPLE_FOLDER/ie2d" "1" "10" "5000" "0.08" "1d-4" "0" "4" "16" "100";;
4) mpirun "-n" "2" "$EXAMPLE_FOLDER/ctest" "1" "$DATA_FOLDER/KRR_DATA/susy_10Kn" "8" "1" "0.1" "10.0" "200" "1e-2" "3" "0" "100";;
...
7) mpirun "-n" "5" "$EXAMPLE_FOLDER/full";;
