...
9) mpirun "-n" "1" "$EXAMPLE_FOLDER/ctest" "3" "5000" "20" "100" "1e-4" "2" "0" "100";;  # test CPP interface with HODLR-LR for product of two random matrices # seems to have a bug when nmpi>1
