...
1) cd $DATA_FOLDER/FULLMAT_DATA
   ...
   mpirun --allow-run-as-root "-n" "8" "$EXAMPLE_FOLDER/smat" "-quant" "--data_dir" "$DATA_FOLDER/FULLMAT_DATA" "--explicitflag" "0" "-option" "--lrlevel" "100" ;; # test sampling-based construction of HODLR with BF for an EM scattering matrix stored in file
