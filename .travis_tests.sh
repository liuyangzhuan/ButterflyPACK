...
12) mpirun "-n" "4" "$EXAMPLE_FOLDER/ie2deigen" "1" "10" "5000" "0.08" "1d-4" "0" "4" "16" "0" "1" "2" "200" "0.01d0" "3" "100" "1" "1" "0" "0";; # test a eigen solver for HODLR with LR for 2d IE 
13) cd $DATA_FOLDER/FULLMAT_DATA
   sh file_merge.sh Frontal_elastic
   cd $TRAVIS_BUILD_DIR/build
    mpirun "-n" "4" "$EXAMPLE_FOLDER/frontaldist" "2500" "$DATA_FOLDER/FULLMAT_DATA/Frontal_elastic/Frontal_elastic_2500" "100" "1e-3" "0";; # test sampling-based construction of HODLR with BF for an 3D elastic Helmholtz frontal matrix stored parallel in file
