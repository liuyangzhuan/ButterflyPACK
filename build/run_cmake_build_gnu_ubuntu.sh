...
#	-Denable_complex=OFF
	# -DCMAKE_Fortran_FLAGS="-cpp -DGNU -O3 -ftracer -funswitch-loops -ftree-vectorize -fimplicit-none -fno-range-check -ffree-line-length-none -ffixed-line-length-none -fopenmp " \
	# -DCMAKE_Fortran_FLAGS="-DGNU -O0 -pg -cpp -fbacktrace -fimplicit-none -fbounds-check -ffree-line-length-none  -ffixed-line-length-none -fopenmp -Wconversion -lpthread " \	
