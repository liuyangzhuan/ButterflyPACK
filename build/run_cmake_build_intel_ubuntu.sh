...
rm -rf CMakeFiles
cmake .. \
	-DCMAKE_Fortran_FLAGS="-cpp -DIntel -nologo -traceback -debug full -O0 -check bounds" \
	...
	# -Denable_complex=OFF
	# -DCMAKE_Fortran_FLAGS="-cpp -DIntel -nologo -traceback -fpe0 -debug full -O0 -check bounds" \ 
	# -DCMAKE_Fortran_FLAGS="-cpp -DIntel -O3 -no-prec-div -align records -parallel -lpthread" \
