      SUBROUTINE psgetrfmod( M, N, A, IA, JA, DESCA, THRESH, IPIV, INFO )
*
...
*  =======
*
*  psgetrfmod computes an LU factorization of a general M-by-N distributed
...
*     .. External Subroutines ..
     ...
     $                   pb_topget, pb_topset, psgemm, psgetf2mod,
...
*
      IF( info.NE.0 ) THEN
         CALL pxerbla( ictxt, 'psgetrfmod', -info )
         RETURN
      END IF
*
...
*     singularity.
*
      CALL psgetf2mod( m, jb, a, ia, ja, desca, THRESH, ipiv, info )
*
      IF( jb+1.LE.n ) THEN
*
...
*        singularity.
*
         CALL psgetf2mod( m-j+ja, jb, a, i, j, desca, THRESH, ipiv, iinfo )
*
