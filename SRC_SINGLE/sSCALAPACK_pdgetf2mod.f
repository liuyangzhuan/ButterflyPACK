      SUBROUTINE pdgetf2mod( M, N, A, IA, JA, DESCA, THRESH, IPIV, INFO )
*
...
*  =======
*
*  pdgetf2mod computes an LU factorization of a general M-by-N
...
*     .. External Subroutines ..
     ...
     $                   pdscal, pdswap, pb_topget, pxerbla, pdelset
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          min, mod
*     ..
...
*
      IF( info.NE.0 ) THEN
         CALL pxerbla( ictxt, 'pdgetf2mod', -info )
