...
! end subroutine delete_grid
   ...
   subroutine CopyStat(stats_i,stats_o)
      ...
      stats_o%Time_BF_MVP_Exchange = stats_i%Time_BF_MVP_Exchange
      stats_o%Time_BF_MVP_All2All = stats_i%Time_BF_MVP_All2All
      stats_o%Time_BF_MVP_Other = stats_i%Time_BF_MVP_Other
      stats_o%Flop_BF_MVP_Gemm_Leaf = stats_i%Flop_BF_MVP_Gemm_Leaf
      stats_o%Flop_BF_MVP_Gemm_Kernel = stats_i%Flop_BF_MVP_Gemm_Kernel
   ...
   subroutine InitStat(stats)
      ...
      stats%Time_BF_MVP_Exchange = 0
      stats%Time_BF_MVP_All2All = 0
      stats%Time_BF_MVP_Other = 0
      stats%Flop_BF_MVP_Gemm_Leaf = 0
      stats%Flop_BF_MVP_Gemm_Kernel = 0
