...
module s_BPACK_hmat_ptg_bridge
   use iso_c_binding
   use s_BPACK_DEFS
   use s_BPACK_factor
   use s_BPACK_block_sendrecv
   use s_BPACK_Utilities
   use s_MISC_Utilities
   use s_Bplus_Utilities
contains

   subroutine s_c_bpack_hmat_ptg_rank(ptree_Cptr, rank) bind(c, name="s_c_bpack_hmat_ptg_rank")
      implicit none
      ...
      rank = ptree%MyID
   end subroutine s_c_bpack_hmat_ptg_rank

   subroutine s_c_bpack_hmat_ptg_size(ptree_Cptr, size) bind(c, name="s_c_bpack_hmat_ptg_size")
      implicit none
      type(c_ptr), intent(in) :: ptree_Cptr
      ...
      call c_f_pointer(ptree_Cptr, ptree)
      size = ptree%nproc
   end subroutine s_c_bpack_hmat_ptg_size

   subroutine s_c_bpack_hmat_ptg_owner_of(hmat_Cptr, ptree_Cptr, row0, col0, owner) bind(c, name="s_c_bpack_hmat_ptg_owner_of")
      implicit none
   ...
   end subroutine s_c_bpack_hmat_ptg_owner_of

   subroutine s_c_bpack_hmat_ptg_diag(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, out_ptr, out_bytes) bind(c, name="s_c_bpack_hmat_ptg_diag")
      implicit none
   ...
   end subroutine s_c_bpack_hmat_ptg_diag

   subroutine s_c_bpack_hmat_ptg_upanel(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, j0, diag_ptr, out_ptr, out_bytes) bind(c, name="s_c_bpack_hmat_ptg_upanel")
      implicit none
      type(c_ptr), intent(in) :: hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr
      ...
      out_ptr = c_loc(buffer(1))
      out_bytes = int(count_dt, c_int64_t)*int(storage_size(buffer(1))/8, c_int64_t)
   end subroutine s_c_bpack_hmat_ptg_upanel

   subroutine s_c_bpack_hmat_ptg_lpanel(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, i0, diag_ptr, out_ptr, out_bytes) bind(c, name="s_c_bpack_hmat_ptg_lpanel")
      implicit none
      type(c_ptr), intent(in) :: hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr
      ...
      out_ptr = c_loc(buffer(1))
      out_bytes = int(count_dt, c_int64_t)*int(storage_size(buffer(1))/8, c_int64_t)
   end subroutine s_c_bpack_hmat_ptg_lpanel

   subroutine s_c_bpack_hmat_ptg_update(hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr, k0, i0, j0, l_ptr, u_ptr) bind(c, name="s_c_bpack_hmat_ptg_update")
      implicit none
      type(c_ptr), intent(in) :: hmat_Cptr, option_Cptr, stats_Cptr, ptree_Cptr, msh_Cptr
      ...
      deallocate(l_block)
      deallocate(u_block)
   end subroutine s_c_bpack_hmat_ptg_update

   subroutine s_c_bpack_hmat_ptg_release_buffer(ptr) bind(c, name="s_c_bpack_hmat_ptg_release_buffer")
      implicit none
   ...
   end subroutine s_c_bpack_hmat_ptg_release_buffer
...
end module s_BPACK_hmat_ptg_bridge
