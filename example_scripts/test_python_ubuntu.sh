...
# mpirun --allow-run-as-root -n $nmpi valgrind --tool=memcheck --leak-check=full --track-origins=yes python ../EXAMPLE/Test_python_allranks.py -option --xyzsort 1 --tol_comp 1e-10 --lrlevel 0 --reclr_leaf 5 --nmin_leaf 128
mpirun --allow-run-as-root -n $nmpi python ../EXAMPLE/Test_python_allranks.py -option --xyzsort 1 --tol_comp 1e-10 --lrlevel 0 --reclr_leaf 5 --nmin_leaf 128 --errsol 1
# python ../EXAMPLE/Test_python_allranks.py -option --xyzsort 1 --tol_comp 1e-10 --lrlevel 0 --reclr_leaf 5 --nmin_leaf 128 --errsol 1
...
# # python -u ${BPACK_PYTHON_LIB_PATH}/dPy_BPACK_worker.py -option --xyzsort 1 --tol_comp 1e-10 --lrlevel 0 --reclr_leaf 5 --nmin_leaf 128 --errsol 1 | tee a.out_seperatelaunch_worker &
