...
do
srun -n 32 --nodes=8 -c $THREADS_PER_RANK --cpu_bind=cores ./EXAMPLE/ie3deigen -quant --data_dir ../EXAMPLE/EM3D_DATA/preprocessor_3dmesh/pillbox_4000 --freq $freq --si 1 --which LM --nev 1 --cmmode 0 -option --reclr_leaf 5 --baca_batch 64 --tol_comp 1e-4 --lrlevel 100 --precon 1 --xyzsort 2 --nmin_leaf 100 --near_para 0.01d0 --pat_comp 3 --format 1 --sample_para $sample_para --knn $knn | tee a.out_freq_$freq
done
